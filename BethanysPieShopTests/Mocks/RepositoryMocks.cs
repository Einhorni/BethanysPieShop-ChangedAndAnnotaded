...
namespace BethanysPieShopTests.Mocks
{
    internal class RepositoryMocks
    {
        public static Mock<IPieRepository> GetPieRepository()
        {
            ...
            //mithilfe der Funktionen kann man auf die Methoden des PieRepository zugreifen, so dass man das Repository mit Mockdaten nicht neu (doppelt) schreiben muss.
        ...
        //die beiden sind weiterhin nur da, damit die Kategorie in der Pie Liste einfacher geschrieben werden kann
